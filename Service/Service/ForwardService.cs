...
namespace Service.Service
{
    public class ForwardService : IForwardService
    {
        ...
        public Task<long> GetUserForwardStatisticalAsync(long userId, DateTime? dateTime)
        {
            throw new NotImplementedException();
        }

        public Task<ForwardStatisticalResult> GetDayAsync(DateTime? dateTime)
        {
            throw new NotImplementedException();
        }

        public Task<ForwardStatisticalResult> GetMonthAsync(DateTime? dateTime)
        {
            throw new NotImplementedException();
        }
    }
